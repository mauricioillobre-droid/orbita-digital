        ...
        <section className="relative py-20 lg:py-28 bg-white overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="font-sans text-lg text-[#0b0f17]/55 max-w-2xl mx-auto leading-relaxed mb-10">
              No hacemos de todo. Nos especializamos en diseño web, automatización y contenido visual.
              Y los tres trabajan juntos cuando hace falta.
            </p>
            <Link href="/contacto"
        ...
        <section className="py-20 bg-white text-center">
          <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="font-display font-bold text-2xl sm:text-4xl text-[#0b0f17] mb-4">
              ¿Sabés qué necesitás?<br />
              <span className="text-[#7c3aed]">Contanos.</span>
            </h2>
            <p className="font-sans text-[#0b0f17]/50 mb-8">
              Si no estás seguro, también podemos ayudarte a entender por dónde arrancar.
            </p>
            <Link href="/contacto"
