    ...
    <footer className="relative bg-[#0b0f17] border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="flex flex-col items-center gap-8">
          ...
          <Link href="/" aria-label="Órbita Digital — Inicio">
            <img src="/logofooter2.png" alt="Órbita Digital" className="h-14 object-contain" />
          </Link>

          <p className="font-sans text-white/28 text-xs tracking-[0.22em] uppercase">
          ...
          <a href={WA_TATI} target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 h-10 rounded-full border border-white/10 text-white/45 hover:text-white hover:border-[#7c3aed]/50 font-sans text-sm font-medium transition-all duration-200 cursor-pointer">
          ...
          <p className="font-sans text-xs text-white/20">© 2025 Órbita Digital. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
